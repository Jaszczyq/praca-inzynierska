                                ...
                                @foreach($events as $event)
                                    <div class="hidden duration-700 ease-in-out" data-carousel-item>
                                        <img
                                            ...
                                            style="aspect-ratio: 16/9; width: 100%; object-fit: cover; border-radius: 10px;" src="{{ $event->image }}" alt="{{ $event->title }}" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
                                        />
                                    </div>
                                @endforeach
                            </div>
