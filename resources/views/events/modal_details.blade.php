...
<script>
    // Przykładowa data, którą chcesz sformatować
    var eventDate = new Date(); // Tutaj wpisz swoją datę

    // Formatowanie godziny do HH:mm
    var timeString = eventDate.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' });

    // Ustawienie sformatowanej godziny w elemencie p
    document.getElementById('event_time').textContent = timeString;
</script>
