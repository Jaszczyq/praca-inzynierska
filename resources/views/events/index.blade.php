...
@section('content')
    <div class="container">
        ...
        {{--                 class="btn btn-primary bg-gray-600 hover:bg-gray-500 border-black mb-3 text-end"> {{ __('events.create') }}--}}
        {{--            </div>--}}
        {{--        @endcan--}}
...
"
                ...
                <script>
                    ...
                    function filterEvents() {
                        // Implementuj logikę filtrowania wydarzeń na podstawie zaznaczonych kategorii
                        // ...
                    }
                </script>
                  ...
                  <b>{{ $event->ticketType }}</b>
                                    ...
                                    <div
                                        ...
                                        <a href="{{ route('event.details', ['id' => $event->id]) }}"
                                           title="{{ $event->title }}">
                                            <img onclick="openModalDetails({{ $event->id }}); event.preventDefault();" src="{{ $event->image }}" alt="{{ $event->title }}"
